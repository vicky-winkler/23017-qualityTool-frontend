<template>
    ...
    <template>
        <Dialog v-model:visible="storageFull" modal header="Error" :style="{ width: '35%' }">
            <span class="text-surface-500 dark:text-surface-400  mb-8">ID: 102</span>
          <br>
          <span class="text-surface-500 dark:text-surface-400  mb-8">Storage is full on this machine! <br> Please contact your administrator</span>
...
function processLogin(decodedOscMessage) {
    ...
    var isAdminInt = parseInt(loginData[1]);

    console.log("LOGIN DATA: isAdmin" + isAdminInt); 
    ...
    overallStore.username = loginData[0];
